...
var changeScale = function(e){
	var s = extrusaoScreen.scaleSelector.valueAsNumber;
	if(s<=0){ 
...
var changePerfilGrau = function(e){
	//console.log(e);
	var s = perfilScreen.grauSelector.valueAsNumber;
	if(s<2){ 
...
var changeTrajetoriaGrau = function(e){
	var s = trajetoriaScreen.grauSelector.valueAsNumber;
	if(s<2){ 
...
var changePerfilSigma = function(e){
	var s = perfilScreen.sigmaSelector.valueAsNumber;
	if(s<=0){ 
...
var changeTrajetoriaSigma = function(e){
	var s = trajetoriaScreen.sigmaSelector.valueAsNumber;
	if(s<=0){ 
...
var changePerfilSegments = function(e){
	var s = perfilScreen.segmentSelector.valueAsNumber;
	if(s<3){ 
...
var changeTrajetoriaSegments = function(e){
	var s = trajetoriaScreen.segmentSelector.valueAsNumber;
	if(s<1){ 
...
var getPerfilCurve = function(){
	if(perfilScreen.tipoSelector.value == "bspline") return perfilCurves.bsplineCurve;
	if(perfilScreen.tipoSelector.value == "rag") return perfilCurves.ragCurve;
}
...
var getTrajetoriaCurve = function(){
	if(trajetoriaScreen.tipoSelector.value == "bspline") return trajetoriaCurves.bsplineCurve;
	if(trajetoriaScreen.tipoSelector.value == "rag") return trajetoriaCurves.ragCurve;
}
