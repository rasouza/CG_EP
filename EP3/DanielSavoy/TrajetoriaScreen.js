var TrajetoriaScreen = function(){
	
	this.id = "trajetoria";
	this.canvas = document.getElementById(this.id);
	this.gl = WebGLUtils.setupWebGL(this.canvas);
	
	this.tipoSelector = document.getElementById("tipoTrajetoria");
	this.segmentSelector = document.getElementById("segmentosTrajetoria");
	this.sigmaSelector = document.getElementById("sigmaTrajetoria");
	this.grauSelector = document.getElementById("grauTrajetoria");
	this.bar = document.getElementById("trajetoriaBar");
	this.zerar = document.getElementById("zerarTrajetoria");
	...
	this.drawControls = function(){
		...
		gl.drawArrays(gl.LINE_STRIP, 0, this.controls.length);
	}
...
TrajetoriaScreen.prototype = new Screen;